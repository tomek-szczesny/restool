...
static float e6_vals[7]   = {1.0, 1.5, 2.2, \
			     3.3, 4.7, \
			     6.8, 10.0};
struct vss e6 = {e6_vals, 6};

static float e12_vals[13] = {1.0, 1.2, 1.5, 1.8, 2.2, \
			     2.7, 3.3, 3.9, 4.7, 5.6, \
			     6.8, 8.2, 10.0};
struct vss e12 = {e12_vals, 12};

static float e24_vals[25] = {1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, \
			     2.7, 3.0, 3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, \
			     6.8, 7.5, 8.2, 9.1, 10.0};
struct vss e24 = {e24_vals, 24};

static float e48_vals[49] = {1.00, 1.05, 1.10, 1.15, 1.21, 1.27, 1.33, 1.40, \
...
static float e96_vals[97] = {1.00, 1.02, 1.05, 1.07, 1.10, 1.13, 1.15, 1.18, \
...
static float e192_vals[193] = {1.00, 1.01, 1.02, 1.04, 1.05, 1.06, 1.07, 1.09, \
...
// Pointer to series struct
// Number of significant from the series struct
// Exponent in base 10
// Bool representing a resistor 0R
struct res{
	struct vss * series;
	int n;
	int e;
